...
const addNewGoal = () => {
    ...
    // Focus on preventing duplicates for now.
        ...
        const isDuplicate = Array.from(existingGoals).some((goal) => goal.textContent === goalInput);
        
        if (isDuplicate) {
            // Display an alert to the user
            alert('This goal already exists. Please choose a different one.');
        } else {
            // Proceed with adding the new goal
